...
<div class="inner-banner-one pt-225 lg-pt-200 md-pt-150 pb-100 md-pb-70 position-relative" style="background-image: url(images/media/img_26.jpg);">
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="text-white d-inline-block position-relative me-xxl-4 me-lg-5">Contact for inquiries</h1>
            </div>
...
<div class="contact-us-section pt-150 lg-pt-80">
    <div class="container">
        <div class="position-relative">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="address-block-one text-center mb-40 wow fadeInUp">
                                ...
                                <p>Open a chat or give us call at <br><a href="tel:310.841.5500" class="call text-lg fw-500">310.841.5500</a></p>
                            </div> <!-- /.address-block-one -->
                        </div>
                        <div class="col-md-4">
                            <div class="address-block-one text-center mb-40 wow fadeInUp">
                                ...
                                <p>live chat service <br><a href="#" class="webaddress">www.CapitalVistalivechat.com</a></p>
                            </div> <!-- /.address-block-one -->
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-wrapper light-bg mt-80 mb-80 lg-mt-40">
                <div class="row">
                    <div class="col-lg-5">
