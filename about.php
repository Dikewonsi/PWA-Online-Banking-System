...
<div class="inner-banner-one pt-225 lg-pt-200 md-pt-150 pb-100 md-pb-70 position-relative" style="background-image: url(images/media/img_26.jpg);">
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="text-white d-inline-block position-relative me-xxl-4 me-lg-5">We are top rated company</h1>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 wow fadeInLeft">
                    <div class="title-one">
                        ...
                        <h3>15k+ Client using Our Services.</h3>
                    </div>
                    <!-- /.title-one -->
                    ...
                    <a href="contact.php" class="btn-three icon-link mt-15 md-mb-40">
                ...
                <div class="col-lg-6 ms-auto wow fadeInRight">
                    <div class="card-style-three d-flex pt-75 lg-pt-40 pb-45 lg-pb-20">
                        ...
                        <div class="ps-4">
                            ...
                            <p>To empower individuals and businesses by providing secure, innovative, and personalized banking solutions that drive financial growth and stability. We are dedicated to fostering financial well-being and inclusion for all, ensuring that everyone has the tools and resources they need to achieve their financial dreams.</p>
                        </div>
                    </div>
                    <!-- /.card-style-three -->
                    <div class="card-style-three d-flex pt-75 lg-pt-40 pb-45 lg-pb-20">
                        ...
                        <div class="ps-4">
                            ...
                            <p>We envision a world where every individual and business has the opportunity to achieve their financial dreams. Our commitment is to provide innovative, secure, and personalized banking solutions that foster growth and prosperity. We strive to be a trusted partner, championing financial well-being and inclusion for all, while contributing positively to the communities we serve. Together, we are shaping a brighter financial future.</p>
                        </div>
                    </div>
                    <!-- /.card-style-three -->
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xxl-5 col-lg-6 ms-auto d-flex flex-column order-lg-last wow fadeInRight">
                ...
                <div><a href="contact.php" class="btn-four mt-15">Let’s Talk</a></div>
