...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Edit Admin | Admin Ragnarok</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Admin - ADMIN_ID = <?= $admin_data['id'];?></h4>
                                        ...
                                        <div>
                                            ...
                                            <form action="codes.php" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <button  type="" name="update_admin" class="btn btn-primary">Edit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
