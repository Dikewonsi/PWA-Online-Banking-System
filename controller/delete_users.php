                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Delete Users</h4>
                                ...
                                <div class="card">
                                    ...
                                    ?>
                                            <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                                <i class="mdi mdi-check-all label-icon"></i><strong>Success</strong> - User Deleted Successfully
                                            ...
                                            <tbody>
                                                <?php foreach ($users as $user): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $user['reason_for_mod'] ?></td>
                                                        <td>
                                                            <a class="btn btn-danger btn-sm Delete" href="delete_user.php?id=<?= $user['userid']; ?>">
