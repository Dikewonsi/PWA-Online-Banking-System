<?php
    ...
    try {
        ...
        if ($admin)
        {
            ...
            // Now you can use $admin_username, $admin_email, etc. to populate the form fields
        } else {
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Profile | Admin Ragnarok</title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-auto order-1 order-sm-2">
                                                <div class="d-flex align-items-start justify-content-end gap-2">
                                                    <div>
                                                        <a href="create_admin.php" type="button" class="btn btn-soft-light"><i class="me-1"></i> Create Admin</a>
                                                    </div>
                                                    <div>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="edit_admin_profiles.php">Edit Admin Profiles</a></li>
                                                                <li><a class="dropdown-item" href="delete_admin_profiles.php">Delete Admin Profiles</a></li>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                            <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                                <i class="mdi mdi-check-all label-icon"></i><strong>Success</strong> - Admin Updated Successfully
                                    ...
                                    ?>
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="card-title-desc">Here are the details for the current admin you are logged in with.</p>
                                            </div>
                                                        ...
                                                        <form action="codes.php" method="post">
                                                            <div>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control" type="text" name="new_username" value="<?= $admin_username; ?>" require id="example-text-input">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="example-search-input" class="form-label">Password</label>
                                                                    <input class="form-control" type="text" name="new_password" value="<?= $admin_password; ?>" require id="example-text-input">
                                                                </div>  
                                                                <div class="mb-3">
