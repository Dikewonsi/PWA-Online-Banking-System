...
<div class="hero-banner-one pt-225 xl-pt-200 lg-pt-150 pb-150 lg-pb-100 position-relative">
    <div class="hero-slider-one m0">
        <div class="item m0">
            <div class="hero-img" style="background-image: url(images/media/img_01.jpg);"></div>
        </div>
        <div class="item m0">
            <div class="hero-img" style="background-image: url(images/media/img_02.jpg);"></div>
        </div>
        <div class="item m0">
            <div class="hero-img" style="background-image: url(images/media/img_03.jpg);"></div>
        </div>
    </div>
    <!-- /.hero-slider-one -->
    <div class="container position-relative">
        <div class="row">
            <div class="col-xl-6 col-lg-7 ms-auto">
                <h1 class=" text-white d-inline-block position-relative fadeInUp">More living, <br> Less banking. </h1>
                <p class="text-xl text-white pt-35 pb-25 wow fadeInUp" data-wow-delay="0.1s">Simplify your finances, simplify your life.</p>
                <a href="contact.php" class="btn-two icon-link wow fadeInUp" data-wow-delay="0.2s">
    ...
    <a href="contact.php" class="more-btn rounded-circle d-flex align-items-center justify-content-center tran3s wow fadeInLeft" target="_blank"><i class="bi bi-arrow-up-right"></i></a>
</div>
<!-- /.hero-banner-one -->
    ...
    <div class="container">
        <div class="position-relative">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-6 d-flex wow fadeInUp">
                ...
                <div class="col-lg-6 col-md-6 d-flex wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card-style-two vstack tran3s w-100 mt-30">
                ...
                <div class="col-lg-6 col-md-6 d-flex wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-style-two vstack tran3s w-100 mt-30">
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="card-style-three pt-45 md-pt-30 pb-35 sm-pb-30">
                        ...
                        <p>At Simplify, our mission is to empower individuals, families, and businesses by providing innovative financial solutions and unparalleled customer service. We are dedicated to building lasting relationships based on trust, integrity, and respect.</p>
                    </div>
                    <!-- /.card-style-three -->
                </div>
                <div class="col-md-5">
                    <div class="border-line h-100 ps-lg-5 pe-lg-5 ps-md-3 pe-md-3">
                        <div class="card-style-three pt-45 md-pt-30 pb-35 sm-pb-30">
                            ...
                            <p>we envision a world where every individual and business has the opportunity to achieve their financial dreams. Our commitment is to provide innovative, secure, and personalized banking solutions that foster growth and prosperity.</p>
                        </div>
                        <!-- /.card-style-three -->
                    </div>
                </div>
