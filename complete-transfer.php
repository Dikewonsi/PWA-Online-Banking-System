<?php 
    ...
    if (!isset($_SESSION['userid']) || !isset($_SESSION['rep_acc_num']) || !isset($_SESSION['rep_fullname'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        try {
            ...
            if ($amount > 0 && $amount <= $balance) {
                ...
                header("Location: verify-transfer-cv.php");
                exit();
            } else {
                $balanceError = true;
            }
  ...
  <section class="pay-money section-b-space">
    <div class="custom-container">
        <form action="" method="POST">
            ...
            <h3 class="person-name">Paying money to <?php echo $rep_fullname; ?></h3>
